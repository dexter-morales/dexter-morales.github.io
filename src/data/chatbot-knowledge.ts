...
export const chatbotKnowledge: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    category: 'experience',
    answer: `${portfolioData.personal.name} has ${portfolioData.personal.yearsExperience}+ years of professional experience. Currently an IT Associate at EntrePro Inc. (2023–2025), previously IT Staff at Royal Amalgamated Product, Inc. (2020–2023). Key achievements include building an MLM platform for 5,000+ users and reducing e-commerce load times by 40%.`,
  },
  {
  ...
  {
    keywords: ['react', 'laravel', 'php', 'mysql', 'javascript', 'typescript', 'tailwind'],
    category: 'skills',
  ...
  },
  {
    ...
    category: 'projects',
    answer: `Featured projects include:\n• MLM Platform — 5,000+ users, custom binary tree logic\n• E-Commerce Platform — 40% performance improvement\n• Back Office Portal — enterprise admin system\n• HRIS — employee management & leave tracking\n• Student Attendance System — device-locked authentication\n• Barangay Document Management — online request system`,
  },
  {
